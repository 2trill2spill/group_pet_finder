myApp.controller("horseController", ["$scope", '$http', 'animalFactory', function($scope, $http, animalFactory) {
    console.log("horse controller working");
    ...
    $scope.getRandomPet = function() {
      ...
      if($scope.animalFactory.animal() === undefined) {
        animalFactory.getRandomPet("horse").then(function() {
